...
export const env: EnvConfig = {
  ...
  // API Configuration
  apiBaseUrl: getEnv('VITE_API_BASE_URL', 'http://localhost:31001/api'),
...
export const logEnvConfig = (): void => {
  if (env.debugMode) {
    console.log('🔧 Environment Configuration:', {
      ...
      emailProvider: env.emailServiceProvider,
      apiUrl: env.apiBaseUrl,
      features: {
        emailVerification: env.enableEmailVerification,
        socialLogin: env.enableSocialLogin,
        twoFactorAuth: env.enable2FA,
      },
    });
  }
};
