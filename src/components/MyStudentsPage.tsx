            ...
            <Card className="p-4 bg-gradient-to-br from-[#FF69B4]/10 to-secondary/10 border-[#FF69B4]/30">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-[#FF69B4]/20 flex items-center justify-center">
                  <Users className="h-6 w-6" style={{ color: '#FF69B4' }} />
                </div>
                <div>
                  <p className="text-2xl font-bold" style={{ color: '#FF69B4' }}>{myStudents.length}</p>
        ...
        {loading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <Button
              ...
              className="bg-[#FF69B4] hover:bg-accent"
            >
              Try Again
            </Button>
          </Card>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Users className="h-5 w-5" style={{ color: '#FF69B4' }} />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {myStudents.map((student, index) => (
                ...
                >
                  <Card className="p-4 hover:shadow-lg transition-all border-secondary hover:border-[#FF69B4]/50">
                    <div className="flex items-start gap-3">
                      <div className="w-14 h-14 rounded-full bg-[#FF69B4]/10 flex items-center justify-center text-2xl">
                        {student.avatar || '👨‍🎓'}
                      </div>
