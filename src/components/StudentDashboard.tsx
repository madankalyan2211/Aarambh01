...
import { BookOpen, Clock, Award, TrendingUp, Flame, Bot, Loader2, ChevronDown, ChevronUp } from 'lucide-react';
...
import { getEnrolledCourses, getAnnouncements, getStudentAssignments, getStudentGrades, getCurrentUser, getAnnouncement } from '../services/api.service';
